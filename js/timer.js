const timer = () => {
    ...
    // Проверка времени для склонения
    ...
    const updateTimer = () => {
        ...
        // Получение времени до dateDeadLine
        ...
        // Форматироваиня текста под временем
        ...
        // Остановка таймера и замена цвета таймера
        if (timeRemaining <= 0) {
